import { main } from "../lib/stacks/products-service/handler";
import {
  createProduct,
  getProductById,
  getProducts,
} from "../lib/stacks/products-service/products.service";

jest.mock("../lib/services/products-service/products.service", () => ({
